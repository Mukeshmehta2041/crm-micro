 ...
 * It converts exceptions into standardized, user-friendly API responses with appropriate HTTP status codes.
 * </p>
 * 
 * <p>Features:</p>
 * <ul>
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles validation errors from @Valid annotations with detailed field-level errors.
     * 
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> handleHttpRequestMethodNotSupportedException(
        ...
        String userFriendlyMessage = String.format("HTTP method '%s' is not supported for this endpoint. Supported methods: %s", 
